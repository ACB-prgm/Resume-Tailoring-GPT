...
ATOM_REGISTRY: List[AtomSpec] = [
    ...
    AtomSpec(
        ...
        content="""
            ...
            conditions. If retry fails, stop and return explicit manual recovery steps in the same
            turn.
        """,
    ...
    AtomSpec(
        ...
        content="""
            Run onboarding in fixed order: intro once per session -> GitHub account/auth + repo
            bootstrap -> intake mode -> section-by-section approvals -> final validation + single
