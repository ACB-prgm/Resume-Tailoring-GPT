...
class ResumeRenderer:
    ...
    def _config_kwargs(self, config_obj, skip_none: bool = True):
        """Internal helper to config kwargs."""
        kwargs = {}
    ...
    def _build_styles(self):
        """Internal helper to build styles."""
        styles = {}
    ...
    def _convert_links(self, text: str) -> str:
        """Internal helper to convert links."""
        pattern = r"\[(.*?)\]\((.*?)\)"
        return re.sub(
            pattern,
    ...
    def _convert_bold(self, text: str) -> str:
        """Internal helper to convert bold."""
        return re.sub(r"\*\*(.*?)\*\*", r"<b>\1</b>", text)

    def _parse_line(self, line: str):
        """Internal helper to parse line."""
        line = line.strip()
    ...
    def _build_story(self, markdown_text: str):
        """Internal helper to build story."""
        story = []
